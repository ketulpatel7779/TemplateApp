package com.mastertemplate.utils.crashreport;
...
public class ReportActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		*/
		...
		target.putExtra(Intent.EXTRA_SUBJECT, "Template App Crash Report on "+ formatter.format(Calendar.getInstance().getTime()));
